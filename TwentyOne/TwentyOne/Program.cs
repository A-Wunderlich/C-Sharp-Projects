...
namespace TwentyOne
{
    class Program
    {
        ...
        {
            Console.WriteLine("Welcome to the Grand Hotel and Casino. Let's start by tellinmg me your name.");
            ...
            if (playerName.ToLower() == "admin")
            {
                ...
                {
                    Console.Write(exeption.Id + " | ");
                    Console.Write(exeption.ExceptionType + " | ");
                    Console.Write(exeption.ExceptionMessage + " | ");
                    Console.Write(exeption.TimeStamp + " | ");
                    Console.WriteLine();
                }
                Console.Read();
                return;
            ...
            if (answer == "yes" || answer == "yeah" || answer == "ya" || answer == "y" || answer == "sure")
            {
                Player player = new Player(playerName, bank);
                player.Id = Guid.NewGuid();
                using (StreamWriter file = new StreamWriter(@"C:\Users\wunde\logs\logs.txt", true))
                {
